<template>
  <div id="loginContainer">
    <div id="loginForm">
      <img src="../assets/logo-tm.png" alt="ICON" style="width: 300px" />
...
export default {
  ...
  methods: {
    async login() {
      //  登录操作
      let inputCode = this.loginForm.verityCode.toUpperCase();
      let sourceCode = this.rightVerityCode.toUpperCase();
